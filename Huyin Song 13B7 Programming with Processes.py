...
General = {
    ...
    1: {"question": "What rule should you use to judge a safe following distance in wet or frosty conditions if driving a car?", "option1": "Two-second rule", "option2": "Four-second rule", "option3": "100 meter rule", "option4": "Six-second rule", "hint": "The answer involves time", "answer": "Four-second rule"},
    2: {"question": "Your vehicle has a current Warrant of Fitness but a rear red stop light is not working\nWhat should you do?", "option1": "You can drive with it until your next WOF", "option2": "You must fix it immediately", "option3": "Only use the vehicle during daylight hours", "option4": "You have 48 hours to drive until it needs fixing", "hint": "Rear stop lights are crucial", "answer": "You must fix it immediately"},
    ...
    4: {"question": "What does a blue sign with a person walking mean?", "option1": "Dance classes ahead", "option2": "No route for pedestrians", "option3": "A route for motorists only", "option4": "A route for pedestrians only", "hint": "Definitely not 'Dance classes ahead'", "answer": "A route for pedestrians only"},
    ...
    6: {"question": "What class of licence do you need to drive a car?", "option1": "Class 1", "option2": "Class 2", "option3": "Class A", "option4": "Class B", "hint": "It's a number", "answer": "Class 1"},
    7: {"question": "Which part of the car prevents too much sound and gas from entering the car?", "option1": "Windows", "option2": "Exhaust and silencer", "option3": "Heater and AC", "option4": "Mudguards and mud flaps", "hint": "Definitely not mudgaurds and mud flaps", "answer": "Exhaust and silencer"},
    8: {"question": "What should you do when you want to turn left?", "option1": "Give 3 seconds warning by indicating", "option2": "Give 2 seconds warning by indicating", "option3": "No need to indicate if no one is behind you", "option4": "Give 1 second of warning by indicating", "hint": "Always indicate when turning", "answer": "Give 3 seconds warning by indicating"},
    9: {"question": "What must be displayed on the back of a trailer being towed at night?", "option1": "A white light", "option2": "A yellow light", "option3": "A green light", "option4": "A red light", "hint": "A highly visible light, but not excessive", "answer": "A red light"},
    10: {"question": "What does reflective triangles placed by the side of the road mean?", "option1": "Roadworks ahead", "option2": "Breakdown or crash ahead", "option3": "Special event ahead", "option4": "One way bridge ahead\nand they have right of way", "hint": "Think of signs that match situations", "answer": "Breakdown or crash ahead"},
}

Emergencies = {
    # 'Emergencies' topic dictionary
    1: {"question": "Who can put a blue sign up?", "option1": "An ambulance driver", "option2": "A police officer", "option3": "A council officer", "option4": "A member of the public", "hint": "Blue signs are compulsary\nplaced by people with control over traffic", "answer": "A police officer"},
    2: {"question": "When must you pull over and allow an ambulance or fire engine to pass?", "option1": "If it is travelling faster than you want to", "option2": "You don't need to let it past\nyou can speed up so you're not holding it up", "option3": "If its siren and/or red flashing lights are on", "option4": "At all times", "hint": "Only when urgent, what shows urgency?", "answer": "If its siren and/or red flashing lights are on"},
    3: {"question": "If you get into a collision, what would be the first step you would take?", "option1": "Call the police", "option2": "Call the ambulance", "option3": "Call your insurance company", "option4": "Check for injuries", "hint": "What is most important?", "answer": "Check for injuries"},
    4: {"question": "If a moving car's front left tire burst, what would happen to the car?", "option1": "The car will sway from side to side", "option2": "The car would be pulled towards the left", "option3": "The car would be pulled towards the right", "option4": "The car would start spinning", "hint": "Which side the tire is on directly affects the car", "answer": "The car would be pulled towards the left"},
    5: {"question": "If you get flashed by oncoming traffic, where would you look?", "option1": "Top left", "option2": "Top right", "option3": "Bottom left", "option4": "Bottom right", "hint": "Away from sources of light", "answer": "Bottom left"},
    6: {"question": "What will happen if your car hits a body of water from a height?", "option1": "You will float on the water", "option2": "You will fall through the water", "option3": "You will hit water like it was a solid", "option4": "You will bounce off the water", "hint": "Think about jumping into a swimming pool", "answer": "You will hit water like it was a solid"},
    7: {"question": "If your car is sinking, how and when should you get out?", "option1": "Open and escape through a window\nbefore the water is higher than the window", "option2": "Escape through the boot once the car fills up", "option3": "Break the front glass as the car is sinking", "option4": "Use the doors once the car comes to a standstill", "hint": "Think in terms of water pressure", "answer": "Open and escape through a window\nbefore the water is higher than the window"},
    8: {"question": "When should you use your hazard lights?", "option1": "Reversing from a driveway when view is unclear", "option2": "Your vehicle is a temporary hazard", "option3": "To scare tailgaters off", "option4": "You have parked on a yellow line", "hint": "The answer is in the name", "answer": "Your vehicle is a temporary hazard"},
    9: {"question": "Driving past parked cars when a ball rolls out, what do you do?", "option1": "Flash your headlights", "option2": "Maintain speed and hit it", "option3": "Accelerate past it", "option4": "Slow and prepare to stop", "hint": "What if a kid follows the ball?", "answer": "Slow and prepare to stop"},
    10: {"question": "What do you do if there are flashing lights outside of a fire station?", "option1": "Slow down and prepare to stop", "option2": "Stop until lights stop flashing", "option3": "Accelerate past it", "option4": "Go tell them they left the lights on", "hint": "The path out should always be available", "answer": "Stop until lights stop flashing"},
}

Parking = {
    # 'Parking' topic dictionary
    1: {"question": "How far should you part from someone's driveway?", "option1": "1 meter", "option2": "2 meters", "option3": "5 meters", "option4": "0.5 meters", "hint": "A decent distance, but not excessive", "answer": "1 meter"},
    2: {"question": "Ethically, should you park very close behind someone else?", "option1": "Yeah sure, no big deal", "option2": "Only if they can drive out through the front", "option3": "No, you should never", "option4": "Only for smaller cars", "hint": "Try to be thoughtful and think 'just in case'", "answer": "Only if they can drive out through the front"},
    3: {"question": "Can you stop on a bus parking lane", "option1": "Yes, if you are driving a bus", "option2": "No, never", "option3": "Only if there are no more parking spots", "option4": "Only if your friends dare you to", "hint": "Disregard what your friends say", "answer": "Yes, if you are driving a bus"},
    4: {"question": "When may you park your vehicle over a fire hydrant?", "option1": "Anytime you want", "option2": "Never should", "option3": "Only if the vehicle can be moved", "option4": "Only if you don't think fires will be happening", "hint": "As long as it doesn't block it", "answer": "Only if the vehicle can be moved"},
    5: {"question": "What does a disability sign painted on the parking spot mean?", "option1": "Park/stop here if you have mobility parking permit", "option2": "Just another empty parking spot", "option3": "If you have a broken leg", "option4": "Just stopping for 5 minutes won't hurt", "hint": "Evidence will tell", "answer": "Park/stop here if you have mobility parking permit"},
    6: {"question": "How close can you park from an intersection?", "option1": "1 meter away", "option2": "3 meters away", "option3": "6 meters away", "option4": "10 meters away", "hint": "Far away", "answer": "6 meters away"},
    7: {"question": "Can you park on the right side of the road?", "option1": "Only if there are marked bays", "option2": "Never", "option3": "Always", "option4": "Only on a one way road", "hint": "Yes, under specific circumstances", "answer": "Only on a one way road"},
    8: {"question": "What does a red x on a blue sign with 'ends' mean?", "option1": "You can stop after you pass this sign", "option2": "You can stop before the sign\nbut not after", "option3": "The sign doesn't matter", "option4": "You cannot stop until permission is given", "hint": "What does x usually mean?", "answer": "You can stop after you pass this sign"},
    9: {"question": "Is it alright to park on someone else's driveway?", "option1": "Only if permission is given", "option2": "No never", "option3": "Only if the owners aren't home", "option4": "Yeah sure, its all public property", "hint": "Don't be rude", "answer": "Only if permission is given"},
    10: {"question": "What happens if you park blocking someone's driveway?", "option1": "The council is called and your car is moved", "option2": "Your car is legally theirs now", "option3": "The owners cannot do anything about it", "option4": "Car won't be moved, you will be fined", "hint": "No extreme measures will be taken", "answer": "The council is called and your car is moved"},
}

Road = {
    # 'Road' topic dictionary
    1: {"question": "Which road may cause the most damage to oncoming traffic?", "option1": "Grassy/Offroad roads", "option2": "Concrete roads", "option3": "Asphalt roads", "option4": "Unsealed/pebble rock roads", "hint": "Which road may cause flying objects?", "answer": "Unsealed/pebble rock roads"},
    2: {"question": "What is the general rule of priority for T intersections?", "option1": "The turning cars always have priority", "option2": "As long as indicators are used, everybody can go", "option3": "It doesn't matter.\ntraffic lights control T intersections", "option4": "The straight road has right of way", "hint": "Think what might happen if...", "answer": "The straight road has right of way"},
    3: {"question": "Who do you give way to in a roundabout?", "option1": "Nobody", "option2": "The left", "option3": "The right", "option4": "There will be traffic lights", "hint": "Oncoming traffic", "answer": "The right"},
    4: {"question": "What do you do as you leave a roundabout?", "option1": "Indicate left", "option2": "Indicate right", "option3": "No need to indicate", "option4": "Flash your lights", "hint": "Show you are taking the exit", "answer": "Indicate left"},
    5: {"question": "What must you do at an intersection controlled by a stop sign?", "option1": "Slow to a stop", "option2": "Just needs to slow down", "option3": "Park there", "option4": "Only stop if there are other people", "hint": "The answer is in the name", "answer": "Slow to a stop"},
    6: {"question": "What's the most important rule for approaching an intersection?", "option1": "Indicate for atleast a second", "option2": "Be prepared to stop", "option3": "Use your horn to warn others", "option4": "Flash your lights to worn others", "hint": "Safety first", "answer": "Be prepared to stop"},
    7: {"question": "What do you do if there is a marked left arrow on your lane's ground?", "option1": "Turn left", "option2": "Go straight", "option3": "Turn right", "option4": "No need to indicate", "hint": "The answer is in the arrow", "answer": "Turn left"},
    8: {"question": "What do you do if there is a marked right arrow on your lane's ground?", "option1": "Turn left", "option2": "Go straight", "option3": "Turn right", "option4": "No need to indicate", "hint": "The answer is in the arrow", "answer": "Turn right"},
    9: {"question": "What do you do if there is a marked straight arrow on your lane's ground?", "option1": "Turn left", "option2": "Go straight", "option3": "Turn right", "option4": "No need to indicate", "hint": "The answer is in the arrow", "answer": "Go straight"},
    10: {"question": "How far can a private vehicle (car, motorbike or truck) drive in a bus only lane?", "option1": "25m", "option2": "50m", "option3": "75m", "option4": "100m", "hint": "A decent distance, but not too far", "answer": "50m"},
}

Rules = {
    # 'Rules' topic dictionary
    1: {"question": "What does a white sign with a red circle around 60 mean?", "option1": "All cars must drive faster than 60km/h", "option2": "The speed limit is 60km/h", "option3": "Your average speed should be around 60km/h", "option4": "60km/h speed limit only for civilian vehicles", "hint": "Too obvious, read road code again", "answer": "The speed limit is 60km/h"},
    2: {"question": "Can restricted licensed drivers bring passengers?", "option1": "No, absolutely not", "option2": "Yes, they can bring anyone", "option3": "Only with supervision, and special cases without", "option4": "As long as your passengers have full licence", "hint": "The freedom doesn't come until full license", "answer": "Only with supervision, and special cases without"},
    ...
    4: {"question": "What is the minimum tread depth required for car tyres?", "option1": "1mm", "option2": "2mm", "option3": "3mm", "option4": "1.5mm", "hint": "Between 1mm and 3mm, not inclusive", "answer": "1.5mm"},
    5: {"question": "Driving a car and trailer with full licence, what is weight limit?", "option1": "4000kg", "option2": "5000kg", "option3": "6000kg", "option4": "7000kg", "hint": "Quite a lot, but not too much", "answer": "6000kg"},
    6: {"question": "You are carring a load that is not properly secured, what are you allowed to do?", "option1": "You can drive until your destination", "option2": "Cannot drive until it is secured", "option3": "You can drive for 200 meters", "option4": "You can drive for 2 kilometers", "hint": "The obvious", "answer": "Cannot drive until it is secured"},
    7: {"question": "If you are driving with a space saver wheel, what must you do?", "option1": "The space saver wheel is no different, do whatever", "option2": "Drive under 80km/h\nto a place you can fix the wheel", "option3": "Only drive under 100km/h", "option4": "Only drive under 60km/h", "hint": "The space saver wheel is not incredible", "answer": "Drive under 80km/h\nto a place you can fix the wheel"},
    8: {"question": "What is the maximum distance a load may overhang your vehicle behind the rear axle?", "option1": "1m", "option2": "2m", "option3": "3m", "option4": "4m", "hint": "Quite a large distance", "answer": "4m"},
    9: {"question": "What should you do before any modification is carried out on your vehicle?", "option1": "Its all OK as long as\nits from a reputable seller", "option2": "Check with an authorised vehicle inspector", "option3": "Get a certificate with the police", "option4": "All modifications are not okay", "hint": "Someone needs to check", "answer": "Check with an authorised vehicle inspector"},
    10: {"question": "Which person can legally stop and perform a roadside check of your vehicle?", "option1": "Ambulance driver", "option2": "Police officer", "option3": "Tow truck driver", "option4": "Nobody", "hint": "These guys have lots of authority", "answer": "Police officer"},
}
